...
# |---|---|---|---|---|---|---|---|---|---|---|
# | pose_hig... | 0.267 | 0.495 | 0.253 | 0.231 | 0.368 | 0.437 | 0.675 | 0.445 | 0.270 | 0.666 |
...
class PoseHigherResolutionNet(nn.Module):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        # self.extration = nn.Conv2d(256, 32, 1, 1)
        # self.extration2 = nn.Conv2d(64, 32, 1, 1)
    ...
    def forward(self, x):
        ...
        # x = self.global_encoder(x, h, w, pos=self.pos_embedding)
